            ...
            <div class="rs-table text-center">
                ...
                >   
                    <template v-slot:items="props">
                        ...
                        <td>{{ props.item.fiveLinesUnSubscriptions ? props.item.fiveLinesUnSubscriptions:"-" }}</td>
                        <td>{{ props.item.twoLinesUpgrade ? props.item.twoLinesUpgrade:"-" }}</td>
                        <td>{{ props.item.threeLinesUpgrade ? props.item.threeLinesUpgrade:"-" }}</td>
                        <td>{{ props.item.fourLinesUpgrade ? props.item.fourLinesUpgrade:"-" }}</td>
                        <td>{{ props.item.fiveLinesUpgrade ? props.item.fiveLinesUpgrade:"-" }}</td>
                        <td>{{ props.item.twoLinesDowngrade?props.item.twoLinesDowngrade :"-" }}</td>
